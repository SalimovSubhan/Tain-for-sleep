...
import 'package:rain_for_sleep/features/home/presentation/widgets/castom_alert_dialog.dart';
...
class HomeScreen extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final isShowSettings = useState<bool>(false);

    return PopScope(
      canPop: !isShowSettings.value,
        ...
        body: Stack(
          children: [
            ...
            isShowSettings.value
                ? CastomAlertDialog(isShowSettings: isShowSettings)
